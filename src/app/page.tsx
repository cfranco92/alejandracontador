      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start max-w-4xl w-full">
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start w-full">
          ...
          <div className="text-center md:text-left flex-1">
            <h1 className="text-4xl font-bold tracking-tight mb-4 text-gray-900 dark:text-white">Alejandra Bertón</h1>
            <h2 className="text-2xl text-gray-600 dark:text-gray-300 mb-6">Contadora Pública</h2>
        ...
        <div className="mt-12 p-8 border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm 
                      bg-white dark:bg-gray-900 w-full backdrop-blur-sm bg-opacity-70 dark:bg-opacity-70
                      transition-all duration-300 hover:shadow-md">
          <p className="text-center text-lg mb-6 text-gray-700 dark:text-gray-300">Página en desarrollo</p>
          <div className="flex justify-center items-center flex-col">
            <p className="text-center text-md text-gray-500 dark:text-gray-400 mb-6">Desarrollado con</p>
            <Image
